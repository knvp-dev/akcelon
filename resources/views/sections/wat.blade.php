<div id="wat">
<section class="hero is-small is-primary is-bold parallax-3">
	<div class="hero-body">
		<div class="container">
			<h1 class="title">
			...
			<div class="hero-content">
				<h2 class="subtitle is-2em has-white-bg">
					“ Ik kan niet de richting van de wind veranderen, maar wel die van mijn zeilen, zodat ik altijd mijn doel bereik. ” 
				</h2>
				<h2 class="subtitle is-2em has-white-bg">
					- Jimmy Dean
				</h2>
...
<section class="section">
	<div class="container has-text-centered">
		<h1 class="title">WAT BIEDEN WE</h1>
		<h2 class="subtitle"><i class="fa fa-circle dot-seperator"></i></h2>
		
		<p>
			Het kan zijn dat externe HR ervaring net datgene is wat je nodig hebt. Akcelon biedt kostenbewust, hoog kwalitatief strategisch HR-advies en -oplossingen in Interim Management, HR Consultancy &amp; Coaching.
		</p>
		<br>
